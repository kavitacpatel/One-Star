...
class MessagesViewController: MSMessagesAppViewController, CLLocationManagerDelegate {
    ...
    @IBAction func HelloWorldButton(_ sender: AnyObject) {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        /*        let locValue:CLLocationCoordinate2D = manager.location!.coordinate
         ...
         newLocation.setValue(locValue.latitude, forKey: "latitude")
         newLocation.setValue(locValue.longitude, forKey: "longitude")
